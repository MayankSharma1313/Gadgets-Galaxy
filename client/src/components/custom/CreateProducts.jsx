...
export const CreateProducts = () => {
  ...
  const flieInputRef = useRef(null);
  ...
  return (
    <div className="w-full sm:max-w-[50%] -z-10 ">
      <CardHeader className="">
        ...
        <CardDescription>
          Enter the details for the new product you want to add to your store
        </CardDescription>
      </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-4 ">
                {
                  ...
                  {images.length < 4 && (
                  <Button
                    onClick={() => flieInputRef.current?.click()}
