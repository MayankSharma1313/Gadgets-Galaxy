...
export const AllProducts = () => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      return handleErrorLogout(error, "Error occoured while updating product");
    }
  ...
  return (
    <div className="mx-auto px-4 sm:px-8 -z-10">
      ...
      {products.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 mx-2 sm:mx-0 ">
                ...
                <div className="grid gap-4 items-center">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="keyboard">Keyboard</SelectItem>
                      <SelectItem value="mouse">Mouse</SelectItem>
                      <SelectItem value="montior">Montior</SelectItem>
                      <SelectItem value="laptop">Laptop</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
