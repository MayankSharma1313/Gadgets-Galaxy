...
export const ReviewsComponent = ({ productId }) => {
  ...
  useEffect(() => {
    const getReviews = async () => {
      try {
        ...
        const data = res.data;
        // setReviewList(data);
        setReviewList(Array.isArray(data) ? data : data?.data || []);
      } catch (error) {}
    };
    getReviews()
  }, [productId]);
  ...
  const deleteReview = async (reviewId) => {
    ...
    try {
      ...
      return handleErrorLogout(error, "Error while delete this review");
    }
  };
  ...
  const editReview = async (reviewId) => {
    ...
    try {
      ...
      return handleErrorLogout(error, "Error while edit this review");
    }
  };
  ...
  return (
    <div className="sm:my-20 my-20 w-[93vw] lg:w-[70vw] mx-auto">
        ...
        {reviewList?.map((review) => (
          ...
          >
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  {startsGenerators(review?.rating, "0", 15)}
                </div>
              </div>
            </div>
            {/* REVIEW CONTENT */}
            ...
            {review?.replies?.length > 0 && (
              <div className=" mt-5 bg-gray-50 rounded-lg p-4 border dark:bg-zinc-800">
              ...
              {user?.id === review?.userId?._id && (
                <>
                  {editing.status ? (
                    ...
                    <span
                      className="flex justify-center items-center gap-2 border-b bg-transparent hover:border-customYellow cursor-pointer text-customYellow"
                      onClick={() =>
                        setEditing({
                          status: true,
                          reviewId: review?._id,
