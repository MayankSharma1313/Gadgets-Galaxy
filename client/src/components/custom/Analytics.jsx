...
export const Analytics = () => {
  ...
  return (
    <div className="w-screen md:w-[90vw]  xl:w-[73vw] flex justify-center items-center ">
      <SidebarInset>
        <div className="flex flex-1 flex-col gap-4 p-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="p-5 bg-muted/50 rounded-lg">
              ...
              <p className="text-sm mt-1 my-8">You made ₹ {metrics?.totalSales?.count} sales this months</p>
