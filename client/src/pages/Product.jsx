        ...
        <main className="w-[93vw] lg:w-[70vw] flex flex-col sm:flex-row justify-start items-start gap-10 mx-auto my-10 ">
          ...
          <div className="grid sm:w-[50%] gap-3">
            <img
              ...
              alt="product image"
              className="object-cover w-full lg:w-[30rem] xl:w-[40rem] rounded-xl border dark:border-none "
            />
          ...
          {/* Right Part */}
          <div className="sm:w-[50%] lg:w-[40%] xl:w-[42%]">
            <div className="pb-5">
              <h2 className="font-extrabold text-2xl ">{product?.name}</h2>
              <p className=" text-sm my-2 ">{product?.description}</p>
              <div className="flex items-center ">
                {startsGenerators(product?.rating, "0", 15)}
              ...
              <div className="flex items-center my-2">
                {product?.colors?.map((color, index) => (
                  <Circle
                    ...
                    className="cursor-pointer hover:brightness-50 filter"
                  />
                ))}
              </div>
              ...
              <div className="py-5">
                <div className="flex gap-3 items-center">
                  ...
                  {productStock - productQuantity > 0 && (
                    <div className="grid text-sm font-semibold text-gray-500">
                      <span>
                        Only{" "}
                ...
                <div className="grid gap-3 my-5">
                  ...
                  <p className="text-sm px-2 ">{availabilty}</p>
                </div>
