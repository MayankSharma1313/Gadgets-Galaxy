import { CheckoutProducts } from "@/components/custom/CheckoutProducts";
        ...
        <div className="space-y-8">
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-1 text-3xl">
              {cartItems.length === 0 ? (
                <h2 className="tetx-primary text-3xl">
                  Nothing to show, Please add some products...
                </h2>
              ) : (
                cartItems.map((item) => (
                  <CheckoutProducts key={item?.id} {...item} />
                ))
              )}
            </div>
            <hr />
          ...
          <Card className="p-4 shadow-md space-y-4">
            ...
            <div className="space-y-2 ">
              ...
              <Input
                id="email"
                type="email"
                placeholder="mayankmsharma13@gmail.com"
                className="w-full "
                value={user?.email}
              />
